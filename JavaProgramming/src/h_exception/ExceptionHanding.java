...
public class ExceptionHanding {
	...
	public static void main(String[] args) {
		 ...
		 *  - 예의 : 프로그램 코드에 의해서 수습될 수 있는 다소 미약한 오류(처리가능)
		 *  
		 *  예외
		 *   - 모든 예의는 Exception 클래스의 자식 클래스이다.
		 ...
		 *   - try 블럭 안의 내용을 실행 중 예외 를 지정할수 있다.
		 *   - catch의 파라미터로 처리할 예외를 지정해줄 수 있다.
		 *   - 발생한 예외와 일치하는 catch 블럭안의 내용이 수행된 후 try-cach를 빠져나간다.
